...
syn cluster markdownBlock contains=markdownH1,markdownH2,markdownH3,markdownH4,markdownH5,markdownH6,markdownBlockquote,markdownListMarker,markdownOrderedListMarker,markdownCheckListMarker,markdownCheckedListMarker,markdownCodeBlock,markdownRule
...
" github flavoured markdown style checkbox support
syn match markdownCheckListMarker "\%(\t\| \{0,4\}\)\[ \] [-*+]\%(\s\+\S\)\@=" contained
syn match markdownCheckedListMarker "\%(\t\| \{0,4\}\)\[[xX]\] [-*+].*$" contained
...
hi def link markdownCheckListMarker       markdownListMarker
hi def link markdownCheckedListMarker     Comment
