...
if version >= 508 || !exists("did_javascript_syn_inits")
  ...
  HiLink es6Function                    Function
  HiLink es6Identifier                  Identifier
  HiLink es6CustomType                  Type
  HiLink es6BuiltInType                 Type
  HiLink es6Repeat                      Repeat
  HiLink es6Special                     Special
  HiLink es6Reserved                    Keyword
  HiLink es6TemplateVar                 Special
  HiLink es6Template                    String
  HiLink es6Rest                        Type
  HiLink javascriptNumber               Number
  HiLink es6Binary                      es6Number
